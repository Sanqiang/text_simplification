...
#SBATCH --job-name=dresstk
#SBATCH --output=dresstk.out
#SBATCH --nodes=1
...
# Run the job
srun python ../../../model/train.py -ngpus 1 -bsize 64 -fw transformer -out dresstk -layer_drop 0.2 -op adagrad -lr 0.01 --mode dresstk -dim 300 -nh 4 -nhl 4 -nel 4 -ndl 4 -lc True -eval_freq 0 --subword_vocab_size 0 --fetch_mode tf_example_dataset --dmode alter
