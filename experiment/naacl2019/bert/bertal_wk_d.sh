...
#SBATCH --job-name=bertal_wkd
#SBATCH --output=bertal_wkd.out
#SBATCH --nodes=1
...
# Run the job
srun python ../../../model/train.py -ngpus 1 -bsize 20 -fw transformer -out bertal_wkd -layer_drop 0.0 -op adagrad -lr 0.01 --mode transbert -nh 8 -nhl 6 -nel 6 -ndl 6 -lc True -eval_freq 0 --fetch_mode tf_example_dataset --subword_vocab_size 0 --dmode wk --tie_embedding all --bert_mode bert_token:bertbase --number_samples 4096 --tune_style 0.0:1.0:0.0:0.0 --tune_mode plus:decoder:cond -warm /zfs1/hdaqing/saz31/text_simplification_0924/bertal_wk/model/model.ckpt-4535134
