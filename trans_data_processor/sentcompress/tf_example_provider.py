...
writer = tf.python_io.TFRecordWriter(
    '/Users/sanqiang/git/ts/text_simplification_data/sentcompress/train/train.tfexample')

file_src = '/Users/sanqiang/git/ts/text_simplification_data/sentcompress/train/train.src'
file_dst = '/Users/sanqiang/git/ts/text_simplification_data/sentcompress/train/train.dst'
